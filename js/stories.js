...
function generateStoryMarkup(story, showDeleteBtn=false) {
  ...
  // Using if statement in side `` to check the exist of delete(trash-can) and 
  //star sign for new story.
  return $(`
      <li id="${story.storyId}">
...
async function deleteStory(event) {
  ...
  // show storyList after removethe new story
...
// add new stories for user (when we click on my stories, you will see all stories of user)
